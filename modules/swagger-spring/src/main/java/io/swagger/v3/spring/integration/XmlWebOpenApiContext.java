...
import io.swagger.v3.spring.integration.api.WebOpenApiContext;
...
public class XmlWebOpenApiContext<T extends XmlWebOpenApiContext<T>> extends SpringOpenApiContext<T> implements WebOpenApiContext {
